document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        pageTitle: { en: 'Nar /nɑr/ - Personal Budget', az: 'Nar /nɑr/ - Şəxsi Büdcə', ru: 'Nar /nɑr/ - Личный бюджет' },
        exportCSV: { en: 'Export CSV', az: 'CSV İxrac Et', ru: 'Экспорт CSV' },
        importCSV: { en: 'Import CSV', az: 'CSV İdxal Et', ru: 'Импорт CSV' },
        wipeData: { en: 'Wipe Data', az: 'Məlumatları Sil', ru: 'Стереть данные' },
        startDate: { en: 'Start Date', az: 'Başlanğıc Tarixi', ru: 'Дата начала' },
        endDate: { en: 'End Date', az: 'Son Tarix', ru: 'Дата окончания' },
        reset: { en: 'Reset', az: 'Sıfırla', ru: 'Сброс' },
        totalIncome: { en: 'Total Income', az: 'Ümumi Gəlir', ru: 'Общий доход' },
        totalExpenses: { en: 'Total Expenses', az: 'Ümumi Xərclər', ru: 'Общие расходы' },
        netCashFlow: { en: 'Net Cash Flow', az: 'Xalis Pul Axını', ru: 'Чистый денежный поток' },
        monthlySavingsGoal: { en: 'Monthly Savings Goal', az: 'Aylıq Əmanət Məqsədi', ru: 'Цель по ежемесячным накоплениям' },
        setGoal: { en: 'Set', az: 'Təyin et', ru: 'Установить' },
        addTransaction: { en: 'Add Transaction', az: 'Əməliyyat Əlavə Et', ru: 'Добавить транзакцию' },
        expensePockets: { en: 'Expense Pockets', az: 'Xərc Ciblisləri', ru: 'Категории расходов' },
        manageCategories: { en: 'Manage Categories', az: 'Kateqoriyalara Nəzarət', ru: 'Управление категориями' },
        spendingAnalysis: { en: 'Spending Analysis', az: 'Xərc Təhlili', ru: 'Анализ расходов' },
        expenseBreakdown: { en: 'Expense Breakdown', az: 'Xərclərin Bölgüsü', ru: 'Разбивка расходов' },
        budgetVsActuals: { en: 'Budget vs. Actuals', az: 'Büdcə və Faktiki Xərclər', ru: 'Бюджет и фактические расходы' },
        trendChartTitle: { en: '6-Month Income vs. Expense Trend', az: '6 Aylıq Gəlir-Xərc Trendi', ru: 'Тренд доходов и расходов за 6 месяцев' },
        savingsChartTitle: { en: 'Savings Journey (12-Month View)', az: 'Əmanət Səyahəti (12 Aylıq Baxış)', ru: 'Динамика накоплений (обзор за 12 месяцев)' },
        // Modals & Forms
        addTransactionTitle: { en: 'Add Transaction', az: 'Əməliyyat Əlavə Et', ru: 'Добавить транзакцию' },
        editTransactionTitle: { en: 'Edit Transaction', az: 'Əməliyyatı Redaktə Et', ru: 'Редактировать транзакцию' },
        amount: { en: 'Amount', az: 'Məbləğ', ru: 'Сумма' },
        ...
        saveTransaction: { en: 'Save Transaction', az: 'Əməliyyatı Yadda Saxla', ru: 'Сохранить транзакцию' },
        addNewCategory: { en: 'Add New Category', az: 'Yeni Kateqoriya Əlavə Et', ru: 'Добавить новую категорию' },
        addCategoryTitle: { en: 'Add Category', az: 'Kateqoriya Əlavə Et', ru: 'Добавить категорию' },
        editCategoryTitle: { en: 'Edit Category', az: 'Kateqoriyanı Redaktə Et', ru: 'Редактировать категорию' },
        categoryName: { en: 'Category Name', az: 'Kateqoriya Adı', ru: 'Название категории' },
        type: { en: 'Type', az: 'Növ', ru: 'Тип' },
        expense: { en: 'Expense', az: 'Xərc', ru: 'Расход' },
        income: { en: 'Income', az: 'Gəlir', ru: 'Доход' },
        icon: { en: 'Icon', az: 'İkon', ru: 'Иконка' },
        monthlyBudget: { en: 'Monthly Budget', az: 'Aylıq Büdcə', ru: 'Месячный бюджет' },
        pocketGroup: { en: 'Pocket Group', az: 'Cib Qrupu', ru: 'Группа расходов' },
        saveCategory: { en: 'Save Category', az: 'Kateqoriyanı Yadda Saxla', ru: 'Сохранить категорию' },
        history: { en: 'History', az: 'Tarixçə', ru: 'История' },
        areYouSure: { en: 'Are you sure?', az: 'Əminsiniz?', ru: 'Вы уверены?' },
        proceed: { en: 'Proceed', az: 'Davam Et', ru: 'Продолжить' },
        // About Modal
        aboutTitle: { en: 'The Story of Nar pomegranate', az: 'Nar hekayəsi', ru: 'История граната Nar' },
        aboutP1: { en: 'In Azerbaijani culture, the pomegranate—or "Nar" /nɑr/—is a powerful symbol of abundance and unity. With its tough outer skin protecting hundreds of precious seeds, it perfectly represents financial wellness: safeguarding your resources so that many small efforts can grow into significant wealth.', az: 'Azərbaycan mədəniyyətində nar bolluq və birliyin güclü simvoludur. Sərt xarici qabığı yüzlərlə qiymətli toxumu qoruduğu kimi, o, maliyyə sağlamlığını mükəmməl təmsil edir: bir çox kiçik səylərin böyük sərvətə çevrilməsi üçün resurslarınızı qoruyur.', ru: 'В азербайджанской культуре гранат, или «Nar» /nɑr/, является мощным символом изобилия и единства. Его прочная кожура защищает сотни драгоценных зерен, что идеально представляет финансовое благополучие: защита ваших ресурсов, чтобы множество малых усилий могли вырасти в значительное богатство.' },
        aboutP2: { en: 'Each seed is a transaction, a saving, a goal. Together, they form a vibrant whole. That is the vision behind Nar.', az: 'Hər bir toxum bir əməliyyat, bir əmanət, bir məqsəddir. Birlikdə onlar canlı bir bütün təşkil edirlər. "Nar"ın arxasındakı baxış budur.', ru: 'Каждое зернышко — это транзакция, сбережение, цель. Вместе они образуют живое целое. В этом заключается видение Nar.' },
        aboutP3: { en: "But the path to abundance isn't always smooth. For its creators, a passionate husband and wife, discussions about money were often filled with... well, *passion*. The problem wasn't a lack of shared dreams, but the absence of a simple, shared language for their finances. They needed a tool to turn potential arguments into moments of alignment.", az: 'Ancaq bolluğa gedən yol həmişə hamar deyil. Onun yaradıcıları olan ehtiraslı ər-arvad üçün pul haqqında müzakirələr çox vaxt... *ehtirasla* dolu olurdu. Problem ortaq arzuların olmaması deyil, maliyyələri üçün sadə, ortaq bir dilin olmaması idi. Potensial mübahisələri uyğunlaşma anlarına çevirmək üçün bir vasitəyə ehtiyacları vardı.', ru: 'Но путь к изобилию не всегда гладок. Для его создателей, страстной супружеской пары, обсуждения денег часто были полны... ну, *страсти*. Проблема была не в отсутствии общих мечтаний, а в отсутствии простого, общего языка для их финансов. Им нужен был инструмент, чтобы превратить потенциальные споры в моменты согласия.' },
        aboutP4: { en: 'Nar was born from this love—a desire to create an intuitive tool that replaces confusion with clarity. It’s a quiet, focused space designed not just for budgeting, but for building a life of abundance together, one seed at a time.', az: 'Nar bu sevgidən doğuldu - qarışıqlığı aydınlıqla əvəz edən intuitiv bir vasitə yaratmaq arzusundan. Bu, təkcə büdcə planlaması üçün deyil, həm də birlikdə, toxum-toxum bolluqla dolu bir həyat qurmaq üçün nəzərdə tutulmuş sakit, fokuslanmış bir məkandır.', ru: 'Nar родился из этой любви — желания создать интуитивно понятный инструмент, который заменяет путаницу ясностью. Это тихое, сфокусированное пространство, предназначенное не только для ведения бюджета, но и для построения совместной жизни в изобилии, зернышко за зернышком.' },
        aboutCreators: { en: 'The Creators of Nar', az: 'Nar-ın Yaradıcıları', ru: 'Создатели Nar' },
        // Dynamic strings
        forThisMonth: { en: 'for this month', az: 'bu ay üçün', ru: 'за этот месяц' },
        summaryPeriod: { en: 'from {0} to {1}', az: '{0} tarixindən {1} tarixinədək', ru: 'с {0} по {1}' },
        budgetLabel: { en: 'Budget: {0}', az: 'Büdcə: {0}', ru: 'Бюджет: {0}' },
        spentLabel: { en: 'Spent: {0}', az: 'Xərclənib: {0}', ru: 'Потрачено: {0}' },
        leftLabel: { en: '{0} left', az: '{0} qalıb', ru: '{0} осталось' },
        overLabel: { en: '{0} over', az: '{0} artıq', ru: '{0} сверх' },
        historyFor: { en: 'History for {0}', az: '{0} üçün tarixçə', ru: 'История по {0}' },
        noTransactions: { en: 'No transactions for this category yet.', az: 'Bu kateqoriya üçün hələ heç bir əməliyyat yoxdur.', ru: 'По этой категории еще нет транзакций.' },
        // Chart labels
        chartBudget: { en: 'Budget', az: 'Büdcə', ru: 'Бюджет' },
        chartSpent: { en: 'Spent', az: 'Xərclənib', ru: 'Потрачено' },
        chartIncome: { en: 'Income', az: 'Gəlir', ru: 'Доход' },
        chartExpenses: { en: 'Expenses', az: 'Xərclər', ru: 'Расходы' },
        chartProjected: { en: 'Projected Savings (Goal)', az: 'Proqnozlaşdırılan Əmanət (Məqsəd)', ru: 'Прогнозируемые накопления (цель)' },
        chartActual: { en: 'Actual Accumulated Savings', az: 'Faktiki Yığılmış Əmanət', ru: 'Фактические накопления' },
        // Alerts
        alertInvalidGoal: { en: 'Please enter a valid, non-negative number for your savings goal.', az: 'Əmanət məqsədiniz üçün etibarlı, mənfi olmayan bir rəqəm daxil edin.', ru: 'Пожалуйста, введите допустимое, неотрицательное число для вашей цели по накоплениям.' },
        alertGoalUpdated: { en: 'Savings goal updated to {0} per month.', az: 'Aylıq əmanət məqsədi {0} olaraq yeniləndi.', ru: 'Цель по накоплениям обновлена до {0} в месяц.' },
        alertInvalidDate: { en: 'Start date cannot be after the end date.', az: 'Başlanğıc tarixi son tarixdən sonra ola bilməz.', ru: 'Дата начала не может быть позже даты окончания.' },
        alertNoExport: { en: 'No transactions to export.', az: 'İxrac üçün heç bir əməliyyat yoxdur.', ru: 'Нет транзакций для экспорта.' },
        alertImportSuccess: { en: 'Successfully imported {0} new transactions.', az: '{0} yeni əməliyyat uğurla idxal edildi.', ru: 'Успешно импортировано {0} новых транзакций.' },
        alertImportNone: { en: 'No new transactions were found to import.', az: 'İdxal üçün yeni əməliyyat tapılmadı.', ru: 'Новых транзакций для импорта не найдено.' },
        // Confirmations
        confirmDeleteTransaction: { en: 'Are you sure you want to delete this transaction?', az: 'Bu əməliyyatı silmək istədiyinizə əminsiniz?', ru: 'Вы уверены, что хотите удалить эту транзакцию?' },
        confirmDeleteCategory: { en: 'Are you sure you want to delete the category "{0}"?', az: '"{0}" kateqoriyasını silmək istədiyinizə əminsiniz?', ru: 'Вы уверены, что хотите удалить категорию "{0}"?' },
        confirmDeleteCategoryWithTransactions: { en: 'This will also delete all transactions associated with "{0}". Are you sure?', az: 'Bu, "{0}" ilə əlaqəli bütün əməliyyatları da siləcək. Əminsiniz?', ru: 'Это также удалит все транзакции, связанные с "{0}". Вы уверены?' },
